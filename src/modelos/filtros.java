...
public class filtros {
       ...
       ArrayList<String[]> lista = new ArrayList<>();
        ...
        try {
            ...
            while(rs.next()){
                    ...
                    reg[4] = String.valueOf(rs.getDouble("cedula"));
    ...
    public static ArrayList<String[]> nivelEd(String nivel){
        ...
        relacionesForaneas.setMgAcademico(nivel);
        int i = relacionesForaneas.buscarMgAcademico();
            ...
            switch(i){
                case 1:
                    query = con.prepareStatement(""
                                ...
                                +" WHERE " +
                                "id_mgAcademico = 1 AND pNombre LIKE '%"+getBuscar()+"%' OR \n" +
                                "id_mgAcademico = 1 AND sNombre LIKE '%"+getBuscar()+"%' OR \n" +
                                "id_mgAcademico = 1 AND pApellido LIKE '%"+getBuscar()+"%' OR \n" +
                                "id_mgAcademico = 1 AND sApellido LIKE '%"+getBuscar()+"%' OR \n" +
                                "id_mgAcademico = 1 AND cedula LIKE '%"+getBuscar()+"%' OR\n" +
                                        
                                "id_mgAcademico = 2 AND pNombre LIKE '%"+getBuscar()+"%' OR \n" +
                                "id_mgAcademico = 2 AND sNombre LIKE '%"+getBuscar()+"%' OR \n" +
                                "id_mgAcademico = 2 AND pApellido LIKE '%"+getBuscar()+"%' OR \n" +
                                "id_mgAcademico = 2 AND sApellido LIKE '%"+getBuscar()+"%' OR \n" +
                                "id_mgAcademico = 2 AND cedula LIKE '%"+getBuscar()+"%' OR\n" +
                                        
                                "id_mgAcademico = 3 AND pNombre LIKE '%"+getBuscar()+"%' OR \n" +
                                "id_mgAcademico = 3 AND sNombre LIKE '%"+getBuscar()+"%' OR \n" +
                                "id_mgAcademico = 3 AND pApellido LIKE '%"+getBuscar()+"%' OR \n" +
                                "id_mgAcademico = 3 AND sApellido LIKE '%"+getBuscar()+"%' OR \n" +
                                "id_mgAcademico = 3 AND cedula LIKE '%"+getBuscar()+"%' OR\n" +
                                        
                                "id_mgAcademico = 4 AND pNombre LIKE '%"+getBuscar()+"%' OR \n" +
                                "id_mgAcademico = 4 AND sNombre LIKE '%"+getBuscar()+"%' OR \n" +
                                "id_mgAcademico = 4 AND pApellido LIKE '%"+getBuscar()+"%' OR \n" +
                                "id_mgAcademico = 4 AND sApellido LIKE '%"+getBuscar()+"%' OR \n" +
                                "id_mgAcademico = 4 AND cedula LIKE '%"+getBuscar()+"%'"); 
                   break;
                case 2:
                    query = con.prepareStatement(""
                                +"SELECT * FROM persona p "
    ...
    /**
     //
     // Esta funcion resive por parametro, distintos posibles filtros y dependiendo de si 
     // algun parametro es distinto de null se modifica la orden sql para ajustarce a ese
     // requisito, filtra personas por rango de edad, direccion, nivel educativo, 
     // tipo de discapacidad, direcccion, y tipo de habitante
     //
     **/    
