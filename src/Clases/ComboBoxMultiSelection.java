...
public class ComboBoxMultiSelection<E> extends JComboBox<E> {        
    ...
    public void setSelectedItems(List<Object> selectedItems) {
        System.out.println("Clases.ComboBoxMultiSelection.setSelectedItems()");
    ...
    public void clearSelectedItems() {
        System.out.println("Clases.ComboBoxMultiSelection.clearSelectedItems()");
        selectedItems.clear();
    ...
    private void removeItemObject(Object obj) {
        System.out.println("Clases.ComboBoxMultiSelection.removeItemObject()");
    ...
    private void addItemObject(Object obj) {
        System.out.println("Clases.ComboBoxMultiSelection.addItemObject()");
    ...
    public ComboBoxMultiSelection() {
        System.out.println("Clases.ComboBoxMultiSelection.<init>()");
    ...
    public void setPopupVisible(boolean v) {
        comboBoxMultiCellEditor.removeItm("Seleccion");
        comboBoxMultiCellEditor.addItem("Seleccion");
        System.out.println("Clases.ComboBoxMultiSelection.setPopupVisible()");
    }
    ...
    private class ComboBoxMultiUI extends FlatComboBoxUI {       
        ...
        protected ComboPopup createPopup() {
            System.out.println("Clases.ComboBoxMultiSelection.ComboBoxMultiUI.createPopup()");
        ...
        protected Dimension getDisplaySize() {
            System.out.println("Clases.ComboBoxMultiSelection.ComboBoxMultiUI.getDisplaySize()");                    
        ...
        public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
           ...
           if (comboList != list) {                
            ...
            if(selectedItems.contains(value)){
                icono = new javax.swing.ImageIcon(getClass().getResource("/recursos/controlar.png"));
            }
            setIcon(icono);     
            return this;
        }
    ...
    private class ComboBoxMultiCellEditor extends BasicComboBoxEditor {
        ...
        protected void removeItm(Object obj) {
    ...
    private class Item extends JLabel {
        ...
        private void init() {
           ...
           /* JButton cmd = new JButton(new FlatSVGIcon("Clases/close.svg", 0.6f));
